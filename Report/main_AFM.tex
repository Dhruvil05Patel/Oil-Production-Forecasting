...
The complete Python codebase (\texttt{final\_AFM\_project.ipynb}) used for data pre-processing, model training, and metric evaluation in this study is publicly available at: \url{https://github.com/your-username/your-repo-link}.
